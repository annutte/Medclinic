...
👉 [Скриншот Workflow на n8n ↗](https://github.com/annutte/Medclinic/blob/main/img/n8n-Workflow.jpg)  
...
👉 [Скриншот SubWorkflow для вычисления доступных слотов ↗](https://github.com/annutte/Medclinic/blob/main/img/n8n-slots-SubWorkflow.jpg)  

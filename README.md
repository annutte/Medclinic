...
n8n – серверная логика ассистента и интеграционный слой. Обрабатывает входящие сообщения из виджета, определяет сценарий, обращается к базе справочников, формирует ответы с использованием API нейросетевых моделей и возвращает их в виджет. Также управляет состоянием сессии через n8n Data Table, ведёт логирование, отправляет уведомления/напоминания.  
👉 [Workflow на n8n](https://github.com/annutte/Medclinic/blob/main/img/n8n-Workflow.jpg)  
  
База данных Grist (справочники) – источник актуальных данных по услугам, ценам, специалистам, расписанию и записям.  

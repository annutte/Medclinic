...
**n8n (self-hosted)** – серверная логика ассистента и интеграционный слой. Обрабатывает входящие сообщения из виджета, определяет сценарий, обращается к базе справочников, формирует ответы с использованием API нейросетевых моделей и возвращает их в виджет. Также управляет состоянием сессии через n8n Data Table, ведёт логирование, отправляет уведомления/напоминания.  
